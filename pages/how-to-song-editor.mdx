...
## Pitch Detection
- Move notes to detected pitch using the right click context menu on a note or phrase.
- Show detected pitch values using the right click context menu on a phrase or using the corresponding button in the settings.
- TIP: You can change the audio that is used for pitch detection in the settings (default: vocals audio).
...
- TIP: The used button can be changed in the settings
