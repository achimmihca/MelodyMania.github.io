...
- A MIDI file contains
    ...
    - TIP: MIDI files with lyrics can be played directly in Melody Mania. Therefor, select the option to search for MIDI files with lyrics.
    - TIP: MIDI files with or without lyrics can be imported in the [editor](/how-to-song-editor) to create a song in the UltraStar format.
