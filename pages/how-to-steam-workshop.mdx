...
- Navigate to the development options in Melody Mania and click the `Publish Workshop Item` button. This will open the upload dialog.
...
- You can only edit your own Workshop items, i.e., items that you have uploaded.
...
- Select the Workshop item to be edited in the upload dialog and set only the value of fields that you want to change.
    - The value of fields that have not been set will not be changed.
