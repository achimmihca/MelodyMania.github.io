        ...
        <div className="container px-5">
            ...
            <div className="collapse navbar-collapse" id="navbarResponsive">
                <ul className="navbar-nav ms-auto me-4 my-3 my-lg-0">
                    ...
                    {/* <li className="nav-item"><RedirectLink className="nav-link" href="https://melodymania.org/help"><T i18nKey="navigationSection_help" /></RedirectLink></li> */}
                    <li className="nav-item"><RedirectLink className="nav-link" href="https://drive.google.com/drive/folders/10bb9wX0Zx3kQ1hE11dwn61l0yOc4z-gm"><T i18nKey="navigationSection_pressKit" /></RedirectLink></li>
                </ul>
            </div>
        </div>
    </nav>
